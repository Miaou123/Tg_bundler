...
import { unifiedBuyFunction } from '../../core/buy';
import { unifiedSellFunction } from '../../core/sell';
...
export async function handleSellTokens(
  ...
  session.currentFunction = 'unifiedSellFunction';
...
export async function handleBuyTokens(
  ...
  session.currentFunction = 'unifiedBuyFunction';
